...
// Données des services d'accompagnement — source de vérité pour l'admin
...
export interface Service {
  ...
  title: string;
  description: string;
  iconName: string; // nom de l'icône Lucide (ex: "Search", "Target"...)
  category: string;
  duration: string;
  price: string;
...
export const services: Service[] = [
  // ==================== DIAGNOSTIC & AUDIT ====================
  {
    ...
    description:
      "Diagnostic complet professionnel de votre CV en 24h par expert RH certifié",
    iconName: "Search",
    category: "Diagnostic",
    duration: "24 heures",
    price: "8 500 FCFA",
    ...
    faq: [
      {
        ...
        answer:
          'Nous analysons seulement votre CV actuel. Vous recevez un rapport détaillé pour corriger vous-même. Si vous voulez que nous le rédigions, choisissez le service "CV Optimisé ATS".',
      },
      {
        question: "Quel format de CV acceptez-vous ?",
        answer:
          "Tous formats : PDF, Word (.doc/.docx), image (JPG/PNG), Google Docs. Même les CV manuscrits scannés sont acceptés.",
      },
      {
        question: "Le délai de 24h est-il garanti même le weekend ?",
        answer:
          "Le délai de 24h s'applique aux jours ouvrés (lundi-vendredi). CV envoyés weekend = rapport lundi soir.",
      },
      {
        question: "Que se passe-t-il si je ne comprends pas le rapport ?",
        answer:
          "La session Q&R de 15 min est incluse pour expliquer tous les points du rapport. Vous pouvez aussi nous contacter par email après.",
      },
    ],
    results: [
...

  {
    ...
    description:
      "Bilan approfondi CV + LinkedIn + Positionnement marché avec plan action 30 jours",
    iconName: "Target",
    category: "Diagnostic",
    duration: "3-5 jours",
    price: "15 000 FCFA",
  ...
  // ==================== RÉDACTION CV ====================
  {
    ...
    description:
      "Rédaction complète CV professionnel compatible tous systèmes ATS avec score 95%+ garanti",
    iconName: "Target",
    ...
    faq: [
      {
        ...
        answer:
          "ATS (Applicant Tracking System) = logiciel utilisé par 75% grandes entreprises africaines et 90% multinationales pour trier automatiquement les CV. Si votre CV n'est pas optimisé ATS, il est rejeté avant qu'un humain le voie. Notre optimisation garantit que votre CV passe ces filtres.",
      },
      {
        question: "Mon CV actuel sera-t-il totalement changé ?",
        answer:
          "Non, nous gardons toutes vos informations et expériences réelles. Nous optimisons la structure, le format, les mots-clés et la présentation pour maximiser l'impact et passer les ATS.",
      },
      {
        question: "Combien de révisions puis-je demander ?",
        answer:
          "3 révisions complètes incluses pendant 7 jours. Chaque révision peut modifier n'importe quelle section. Au-delà, révisions à 3 000 FCFA/révision.",
      },
      {
        question: "Le CV fonctionnera-t-il pour candidatures internationales ?",
        answer:
          "Oui, notre format est universel et fonctionne pour candidatures au Cameroun, en Afrique et à l'international. Nous adaptons le format selon la zone géographique cible si précisée.",
      },
    ],
    results: [
...

  {
    ...
    description:
      "CV spécial débutants valorisant stages, projets et formations même sans expérience pro",
    ...
    faq: [
      {
        ...
        answer:
          "Nous mettons en avant vos stages (même 1 mois), projets académiques, mémoires, travaux de groupe, compétences techniques, formations, certifications, activités associatives, bénévolat et soft skills.",
      },
      {
        question: "Mon CV fera-t-il vraiment 1 page alors que j'ai peu de contenu ?",
        answer:
          "Oui, 1 page est idéal et même recommandé pour jeunes diplômés. Nous remplissons intelligemment avec vos formations, compétences, projets et soft skills de façon structurée et aérée.",
      },
      {
        question: "Puis-je utiliser ce CV pour postuler dans différents secteurs ?",
        answer:
          "Oui, nous créons une version polyvalente. Le guide inclus vous explique comment adapter l'objectif et les compétences selon le poste visé en 5 minutes.",
      },
    ],
    testimonial: {
      name: "Adjara Diallo",
      role: "Assistante Administrative Junior - Yaoundé",
      text: "Sans aucune expérience après mes études, je pensais ne jamais décrocher. Le CV Irelis m'a ouvert 5 portes en 2 semaines. J'ai signé mon 1er CDI le mois suivant.",
    },
  },

  {
    ...
    description:
      "CV prestige pour cadres supérieurs et dirigeants avec storytelling carrière impactant",
    iconName: "Award",
    category: "Executive",
    duration: "5-7 jours",
    price: "45 000 FCFA",
...

  {
    ...
    description:
      "CV format international bilingue FR/EN adapté standards Europe, Canada, USA",
    iconName: "Globe",
  ...
  // ==================== LETTRES & EMAILS ====================
  {
    ...
    description:
      "Rédaction 100% personnalisée lettre motivation percutante adaptée au poste visé",
    iconName: "FileText",
    category: "Rédaction",
    duration: "24-48h",
    price: "12 000 FCFA",
...

  {
    ...
    description:
      "Email candidature spontanée court et percutant de 150-200 mots avec objet accrocheur",
    iconName: "Send",
    category: "Rédaction",
    duration: "24h",
    price: "5 000 FCFA",
...

  {
    ...
    description:
      "Pack économique de 5 lettres personnalisées pour campagne candidatures multiples",
    iconName: "Package",
    category: "Rédaction",
    duration: "5-7 jours",
    price: "45 000 FCFA",
  ...
  // ==================== TEMPLATES ====================
  {
    ...
    description:
      "Modèle CV Word professionnel moderne téléchargeable instantanément",
    iconName: "FileText",
    category: "Templates",
    duration: "Immédiat",
    price: "3 500 FCFA",
...

  {
    ...
    description:
      "Collection 10 designs CV professionnels styles variés pour tester et choisir le meilleur",
    iconName: "Package",
    category: "Templates",
    duration: "Immédiat",
    price: "12 000 FCFA",
...

  {
    ...
    description:
      "15 modèles lettres motivation pré-rédigées par secteur activité prêts personnalisation",
    iconName: "Mail",
    category: "Templates",
    duration: "Immédiat",
    price: "2 500 FCFA",
...

  {
    ...
    description:
      "Pack complet tous templates : 10 CV, 15 lettres, 5 emails, 3 relances + guides",
    iconName: "Package",
    category: "Templates",
    duration: "Immédiat",
    price: "15 000 FCFA",
  ...
  // ==================== COACHING & PRÉPARATION ====================
  {
    ...
    description:
      "Session coaching 1h30 avec simulation entretien réaliste et feedback expert RH",
    iconName: "Users",
    category: "Coaching",
    duration: "1h30",
    price: "35 000 FCFA",
...

  {
    ...
    description:
      "Accompagnement progressif sur 3 sessions espacées avec suivi 30 jours complet",
    iconName: "Users",
    category: "Coaching",
    duration: "3 sessions",
    price: "90 000 FCFA",
...

  {
    ...
    description:
      "Batterie complète tests psychotechniques avec correction détaillée et entraînement",
...

  {
    ...
    description:
      "Stratégie personnalisée négociation salaire avec benchmark marché et simulation",
    iconName: "DollarSign",
    category: "Coaching",
    duration: "1h session",
    price: "25 000 FCFA",
  ...
  // ==================== VISIBILITÉ & PERSONAL BRANDING ====================
  {
    ...
    description:
      "Optimisation complète profil LinkedIn pour visibilité maximale auprès recruteurs",
    iconName: "TrendingUp",
    category: "Visibilité",
    duration: "3-5 jours",
    price: "28 000 FCFA",
...

  {
    ...
    description:
      "Pack complet CV ATS + LinkedIn + Lettre + Stratégie pour visibilité maximale",
    iconName: "Star",
    category: "Visibilité",
    duration: "7-10 jours",
    price: "65 000 FCFA",
  ...
  // ==================== STRATÉGIE & MÉTHODOLOGIE ====================
  {
    ...
    description:
      "Méthode complète et personnalisée recherche emploi efficace en Afrique",
    iconName: "MapPin",
    category: "Stratégie",
    duration: "1 semaine",
    price: "28 000 FCFA",
...

  {
    ...
    description:
      "Accompagnement complet reconversion professionnelle sur 3-4 semaines",
    iconName: "Award",
...

  {
    ...
    description:
      "Bilan compétences complet avec tests orientation et projet professionnel",
